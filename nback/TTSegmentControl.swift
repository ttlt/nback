...
public class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var defaultTextFont: UIFont = UIFont.helveticaNeueLight(20)
    @IBInspectable open var selectedTextFont: UIFont = UIFont.helveticaNeueLight(20)
    ...
    //Customize from 2018/2/24
    @IBInspectable open var defaultTextFontSize: CGFloat = 12
    @IBInspectable open var selectedTextFontSize: CGFloat = 12
